...
import com.zdjc.zdjcyun.mvp.presenter.impl.ProjectMarkPresenterImpl;
...
import com.zdjc.zdjcyun.mvp.viewmodel.IProjectMarkModel;
...
public class ProjectMarkModel extends BaseModel<ActivityProjectDetailBinding, ProjectMarkPresenterImpl> implements
        IProjectMarkModel, OnItemClickListener{
    ...
    public void onCreate() {
        ...
        mBinder.include.imgbtnBack.setOnClickListener(v -> ((ProjectDetailActivity)UI).finish());
        initData();
    }
    ...
    public void initData() {
        ...
        projectListRecycViewAdapter = new ProjectListRecycViewAdapter((ProjectDetailActivity)UI);
        ...
        /** with Fragment */
        mBinder.tl2.setTabData(mTabEntities, (ProjectDetailActivity)UI, R.id.fl_change1, mFragments);
...
//            PreferenceUtils.putInt(BaseApplication.getContext(),"projectId",dataBeanList.get(0).getProjectId());
    ...
    private void myProjectListDialog(List<AllProjectListEntity.DataBean> dataBeanList) {
        ...
        ProjectDetailActivity projectDetailActivity = (ProjectDetailActivity)UI;
        dialog = new Dialog(projectDetailActivity, R.style.dialog);
        ...
        dialog.show();
        // 适配屏幕 screenAdaptive
        WindowManager wm = ((ProjectDetailActivity)UI).getWindowManager();
