...
import com.zdjc.zdjcyun.mvp.presenter.ITextViewPresenter;
...
public class TextViewPresenterImpl extends BaseNetControl implements ITextViewPresenter {

    @Override
    public void getTextMessage(RequestCallBack callBack, Map<String, String> params, int tag) {
        /**
         * 请求前
         */
        callBack.beforeRequest(tag);
        HttpRequestImpl.getInstance().projectCotacteMsg(params)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<ProjectContactEntity>() {
                    @Override
                    ...
                    @Override
                    public void onNext(ProjectContactEntity value) {
                        /**
                         * 这里是回掉成功的
                         */
                        if(value.getCode()==0){
