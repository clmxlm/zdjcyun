...
import com.zdjc.zdjcyun.mvp.presenter.ITestProjectDetailPresenter;
...
public class TestProjectDetailPresenterImpl extends BaseNetControl implements ITestProjectDetailPresenter {

    @Override
    public void getProjectOnSiteImage(RequestCallBack callBack, Map<String, String> params, int tag) {
        /**
         * 请求前
         */
        callBack.beforeRequest(tag);
        HttpRequestImpl.getInstance().projectOnSiteImage(params)
                ...
                .subscribe(new Observer<ImageEntity>() {
                    ...
                    @Override
                    public void onNext(ImageEntity value) {
                        /**
                         * 这里是回掉成功的
                         */
                        if(value.getCode()==0){
