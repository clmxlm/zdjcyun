...
import com.zdjc.zdjcyun.mvp.presenter.HazardsPresenter;
...
public class HazardsPresenterImpl extends BaseNetControl implements HazardsPresenter {


    @Override
    public void getHazardsInfo(RequestCallBack callBack, Map<String, String> params, int tag) {
        /**
         * 请求前
         */
        callBack.beforeRequest(tag);
        HttpRequestImpl.getInstance().getHazards(params)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<HazardsEntity>() {
                    @Override
                    ...
                    @Override
                    public void onNext(HazardsEntity value) {
                        /**
                         * 这里是回掉成功的
                         */
                        if(value.getCode()==0){
