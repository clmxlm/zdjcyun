 ...
 */
public class RotateDefaultOnDoubleTapListener implements
		GestureDetector.OnDoubleTapListener {

	private RotatePhotoViewAttacher photoViewAttacher;
	 ...
	 */
	public RotateDefaultOnDoubleTapListener(RotatePhotoViewAttacher photoViewAttacher) {
	 ...
	 *            PhotoViewAttacher to bind to
	 */
	public void setPhotoViewAttacher(RotatePhotoViewAttacher newPhotoViewAttacher) {
