...
public class ProjectListPresenterImpl extends BaseNetControl implements IProjectListPresenter {
    ...
    @Override
    public void getQueryProjectStatusCount(RequestCallBack callBack, Map<String, String> params, int tag) {
        /**
         * 请求前
         */
        callBack.beforeRequest(tag);
        HttpRequestImpl.getInstance().queryProjectStatusCount(params)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<ProjectTotalStatusEntity>() {
                    @Override
                    public void onSubscribe(Disposable d) {
                        /**
                         * 这个就是rxjava的任务对象
                    ...
                    @Override
                    public void onNext(ProjectTotalStatusEntity value) {
                        /**
                         * 这里是回掉成功的
                         */
                        if(value.getCode()==0){
    ...
    @Override
    public void getQueryAlarmProject(RequestCallBack callBack, Map<String, String> params, int tag) {
        /**
         * 请求前
         */
        callBack.beforeRequest(tag);
        HttpRequestImpl.getInstance().queryAlarmProject(params)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<AlarmNewsEntity>() {
                    @Override
                    public void onSubscribe(Disposable d) {
                        /**
                         * 这个就是rxjava的任务对象
                    ...
                    @Override
                    public void onNext(AlarmNewsEntity value) {
                        /**
                         * 这里是回掉成功的
                         */
                        if(value.getCode()==0){
    ...
    @Override
    public void getQueryWillProject(RequestCallBack callBack, Map<String, String> params, int tag) {
        /**
         * 请求前
         */
        callBack.beforeRequest(tag);
        HttpRequestImpl.getInstance().queryWillProject(params)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<WillProjectedEntity>() {
                    @Override
                    public void onSubscribe(Disposable d) {
                        /**
                         * 这个就是rxjava的任务对象
                    ...
                    @Override
                    public void onNext(WillProjectedEntity value) {
                        /**
                         * 这里是回掉成功的
                         */
                        if(value.getCode()==0){
    ...
    @Override
    public void getQueryMonitorView(RequestCallBack callBack, Map<String, String> params, int tag) {
        /**
         * 请求前
         */
        callBack.beforeRequest(tag);
        HttpRequestImpl.getInstance().queryMonitorView(params)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<MonitorViewEntity>() {
                    @Override
                    public void onSubscribe(Disposable d) {
                        /**
                         * 这个就是rxjava的任务对象
                    ...
                    @Override
                    public void onNext(MonitorViewEntity value) {
                        /**
                         * 这里是回掉成功的
                         */
                        if(value.getCode()==0){
