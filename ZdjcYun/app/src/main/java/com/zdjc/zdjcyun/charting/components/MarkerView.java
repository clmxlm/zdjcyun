package com.zdjc.zdjcyun.charting.components;
...
public class MarkerView extends RelativeLayout implements IMarker {
    ...
    /**
     * Constructor. Sets up the MarkerView with a custom activity_begin resource.
     *
     * @param context
     * @param layoutResource the activity_begin resource to use for the MarkerView
     */
    ...
    /**
     * Sets the activity_begin resource for a custom MarkerView.
     *
