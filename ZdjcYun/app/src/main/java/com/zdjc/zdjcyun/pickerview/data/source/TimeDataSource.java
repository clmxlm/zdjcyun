package com.zdjc.zdjcyun.pickerview.data.source;


import com.zdjc.zdjcyun.pickerview.data.WheelCalendar;
...
public interface TimeDataSource {
    ...
    int getMinSeconds(int year, int month, int day, int hour,int minute);

    int getMaxSeconds(int year, int month, int day, int hour,int minute);
