 ...
 */
public class ProjectDetailFragment extends BaseFragment<FragmentProjectDetailBinding,ProjectDetailModel> {
    ...
    public static ProjectDetailFragment newInstance(String param2) {
...
//    public void tvChooseTime(View view){
//        mModel.ChooseTime();
//    }
