...
import com.zdjc.zdjcyun.mvp.presenter.IBasicInformationPresenter;
...
public class BasicInformationPresenterImpl extends BaseNetControl implements IBasicInformationPresenter {

    @Override
    public void getBasicInformation(RequestCallBack callBack, Map<String, String> params, int tag) {
        /**
         * 请求前
         */
        callBack.beforeRequest(tag);
        HttpRequestImpl.getInstance().querySector(params)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<BasicInformationEntity>() {
                    @Override
                    ...
                    @Override
                    public void onNext(BasicInformationEntity value) {
                        /**
                         * 这里是回掉成功的
                         */
                        if(value.getCode()==0){
