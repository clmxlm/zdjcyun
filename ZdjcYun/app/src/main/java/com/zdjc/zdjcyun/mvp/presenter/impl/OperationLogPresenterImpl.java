...
import com.zdjc.zdjcyun.mvp.presenter.IOperationLogPresenter;
...
public class OperationLogPresenterImpl extends BaseNetControl implements IOperationLogPresenter {

    @Override
    public void getOperationLog(RequestCallBack callBack, Map<String, String> params, int tag) {
        /**
         * 请求前
         */
        callBack.beforeRequest(tag);
        HttpRequestImpl.getInstance().queryOperated(params)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<OperationLogEntity>() {
                    @Override
                    ...
                    @Override
                    public void onNext(OperationLogEntity value) {
                        /**
                         * 这里是回掉成功的
                         */
                        if(value.getCode()==0){
