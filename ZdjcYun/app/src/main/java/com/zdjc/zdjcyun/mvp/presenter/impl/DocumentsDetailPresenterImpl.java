...
import com.zdjc.zdjcyun.mvp.presenter.DocumentsDetailPresenter;
...
public class DocumentsDetailPresenterImpl extends BaseNetControl implements DocumentsDetailPresenter {

    @Override
    public void getQueryDocuments(RequestCallBack callBack, Map<String, String> params, int tag) {
        /**
         * 请求前
         */
        callBack.beforeRequest(tag);
        HttpRequestImpl.getInstance().getDocuments(params)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<DocumentEntity>() {
                    @Override
                    ...
                    @Override
                    public void onNext(DocumentEntity value) {
                        /**
                         * 这里是回掉成功的
                         */
                        if(value.getCode()==0){
