...
package com.zdjc.zdjcyun.pickerview.wheel;
...
import com.zdjc.zdjcyun.pickerview.adapters.WheelViewAdapter;
import com.zdjc.zdjcyun.pickerview.config.DefaultConfig;
...
public class WheelView extends View {
    ...
    // Items activity_begin
    private LinearLayout itemsLayout;
    // The number of first item in activity_begin
...
//        mPaintLineRight.setStrokeWidth(context.getResources().getDimensionPixelSize(R.dimen.picker_line_width));
     ...
     * Actual amount of visible items depends on wheel activity_begin parameters.
    ...
    /**
     * Calculates desired height for activity_begin
     *
     * @param layout the source activity_begin
     * @return the desired activity_begin height
     */
     ...
     *
     * @param widthSize the input activity_begin width
     * @param mode      the activity_begin mode
     ...
     *
     * @param width  the activity_begin width
     * @param height the activity_begin height
     */
...
//        centerDrawable.draw(canvas);
    ...
    /**
     * Adds view for item to items activity_begin
     *
     * @param index the item index
