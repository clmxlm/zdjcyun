...
import com.zdjc.zdjcyun.mvp.presenter.IProjectManagePresenter;
...
public class ProjectManagePresenterImpl extends BaseNetControl implements IProjectManagePresenter {

    @Override
    public void getQueryProjects(RequestCallBack callBack, Map<String, String> params, int tag) {
        /**
         * 请求前
         */
        callBack.beforeRequest(tag);
        HttpRequestImpl.getInstance().queryProjects(params)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<ProjectManageEntity>() {
                    @Override
                    ...
                    @Override
                    public void onNext(ProjectManageEntity value) {
                        /**
                         * 这里是回掉成功的
                         */
                        if(value.getCode()==0){
